...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Check if user has access to User app
            ...
            if (user) {
                ...
                const redirectUrl = getRedirectUrlIfNeeded(userRole, 'user');

                if (redirectUrl) {
                    // User doesn't have access to User app, redirect to appropriate app
