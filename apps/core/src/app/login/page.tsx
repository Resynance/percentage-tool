...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Check if user has access to Core app
            ...
            if (user) {
                ...
                const redirectUrl = getRedirectUrlIfNeeded(userRole, 'core');

                if (redirectUrl) {
                    // User doesn't have access to Core app, redirect to appropriate app
