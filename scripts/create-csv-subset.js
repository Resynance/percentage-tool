#!/usr/bin/env node
/**
 * Create a subset of CSV records
 * Run from project root: node scripts/create-csv-subset.js
 */
...
const outputFile = '/Users/max/Downloads/qa_feedback_with_tasks_subset_500.csv';
